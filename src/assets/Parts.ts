...
export type PartsType = "반지" | "모자" | "엠블렘" | "펜던트" | "얼굴장식" |
    ...
    "하의" | "장갑" | "망토" | "신발" | "android " | "기계심장";

//옵션들
export type Option =  "올스탯" | "공격력" | "공격력 / 마력" | "최대 HP" | "최대 HP / 최대 MP" | "최대 HP% / 최대 MP%" | "방어력" |
    "보스 몬스터 공격 시 데미지" | "몬스터 방어율 무시" | "크리티컬 데미지" | "주스탯 / 부스탯" |
    "일반 몬스터 공격 시 데미지" | "데미지" |
    "상태 이상 내성" | "모든 스킬 레벨+2(5차 스킬 제외)" | "이동속도" | "점프력" | "공격 시 5% 확률로 2레벨 빙결효과 적용";

//% 옵션들
export const percentOptions: readonly Option[]
    = ["최대 HP% / 최대 MP%", "보스 몬스터 공격 시 데미지", "몬스터 방어율 무시", "크리티컬 데미지", "일반 몬스터 공격 시 데미지", "데미지"];
