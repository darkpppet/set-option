...
import {type ItemData, isItemData, type SetOption } from './Parts'
...
export default function checkSet(itemsData: readonly (ItemData | null)[][]): NowSetData[] {
    ...
    setsData.forEach(i => {
        ...
        //럭키아이템 관련
        const setItems = [...i.items]; //세트에 있는 템들: 럭키아이템 적용되면 그템으로 바꿔버릴거임
